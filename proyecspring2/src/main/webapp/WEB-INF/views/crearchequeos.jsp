...
<body>
   ...
   <!---Menu---->    
    ...
    <div class="col-9 col-s-9" id="tableRegistro">
        ...
        <form method="post" action="procesarchequeos">
            <h2>Crear Chequeo</h2>
            <table>
<!--             	 <tr> -->

<!--                     <td><label for="idchequeo">ID Chequeo: </label></td> -->
<!--                     <td><input type="text" name="idchequeo" placeholder="000" /></td> -->
<!--                 </tr> -->
                ...
                <tr>
                    ...
                    <td><input type="text" name="nomcheq" placeholder="Tipo de chequeo..." /></td>
                </tr>
                <tr>
                    ...
                    <option disabled selected > -- Selecciona una Opción -- </option>
                    <option value="00.000.000"><c:out value="${ru.getCliente_rutcliente()}"/></option>
